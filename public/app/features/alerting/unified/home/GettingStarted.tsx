    ...
    <Stack gap={2} direction="column">
      <ContentBox className={cx(styles.ctaContainer, className)}>
        <WelcomeCTABox
          ...
          description={t("ablestack-wall.alert.alert-rule-description", "Define the condition that must be met before an alert rule fires")}
          href="/alerting/list"
        ...
        <WelcomeCTABox
          ...
          description={t("ablestack-wall.alert.contact-points-description", "Configure who receives notifications and how they are sent")}
        ...
        <WelcomeCTABox
          ...
          description={t("ablestack-wall.alert.notification-policies-description", "Configure how firing alert instances are routed to contact points")}
